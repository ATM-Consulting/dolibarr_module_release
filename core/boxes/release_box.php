 ...
 */
class releasebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "release@release";
    public $boxlabel;
    public $depends = array("release");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/release/class/release.class.php";
